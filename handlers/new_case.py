...
def get_credentials():
    ...
    creds = None
    if os.path.exists('token_4.json'):
        os.chmod('token_4.json', 0o666)
        creds = Credentials.from_authorized_user_file('token_4.json', SCOPES)
    if not creds or not creds.valid:
        ...
        with open('token_4.json', 'w') as token:
